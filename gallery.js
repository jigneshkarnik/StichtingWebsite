// Simple gallery.js - reads event data from sessionStorage (passed from events.html)
// No embedded JSON - data comes from events.html only
...
/**
 * Load event from sessionStorage and initialize gallery
 */
function initializeGallery() {
    const eventDataStr = sessionStorage.getItem('currentEvent');
    ...
    try {
        ...
        document.getElementById('gallery-grid').innerHTML = '<div class="loading">Error loading event data</div>';
        return;
    }
